...
function parisMap(elementId) {
  let baseUrl = 'http://localhost:4000/paris-project'
  if (document.location.href.match(/localhost:3001/)) {
    baseUrl = 'http://localhost:3001/exist/rest/db/apps/sade-architrave/templates/itinerary'
  }
  if (document.location.href.match(/architrave.eu\/dev/)) {
    baseUrl = 'https://architrave.eu/dev/itinerary'
  } else {
    if (document.location.href.match(/architrave.eu\/dev/)) {
      baseUrl = 'https://architrave.eu/itinerary'
    }
  }
  ...
  //Paris 1733 Overlay
  // var imageUrl = `${baseUrl}/raster/9_plan_de_paris_1733.png`,
