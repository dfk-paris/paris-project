...
function arrowMap(elementId) {
  ...
  //Map
  //Init Map
  var map = L.map(elementId).setView([48.856667, 2.351667], 5);
  ...
  //Knesebeck Group
  var knesebeck = L.layerGroup([L.geoJSON(data, {style:{"color":"#ff0066"}, filter:function(feature, layer) {
          return feature.properties.visitor=="Knesebeck";
      }})]);

  //Corfey Group
  var corfey = L.layerGroup([L.geoJSON(data, {style:{"color":"#000099"}, filter:function(feature, layer) {
          return feature.properties.visitor=="Corfey";
      }})]);

  //Pitzler Group
  var pitzler = L.layerGroup([L.geoJSON(data, {style:{"color":"#ffcc00"}, filter:function(feature, layer) {
          return feature.properties.visitor=="Pitzler";
      }})]);

  //Neumann Group
  var neumann = L.layerGroup([L.geoJSON(data, {style:{"color":"#ff9900"}, filter:function(feature, layer) {
          return feature.properties.visitor=="Neumann";
      }})]);

  //Harrach Group
  var harrach = L.layerGroup([L.geoJSON(data, {style:{"color":"#ff0000"}, filter:function(feature, layer) {
